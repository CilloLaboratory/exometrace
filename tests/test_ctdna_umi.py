...
class CtDnaWorkflowShapeTests(unittest.TestCase):
    ...
    def test_bwa_alignment_stages_reference_sidecars(self) -> None:
        ...
        self.assertIn('reference_bwa_classic_bwt = file("${reference_fasta}.bwt", checkIfExists: true)', workflow_text)
        self.assertIn('reference_bwa_classic_sa = file("${reference_fasta}.sa", checkIfExists: true)', workflow_text)
        ...
        self.assertIn('path(ref_fasta), path(ref_fasta_fai), path(ref_fasta_dict), path(ref_fasta_amb), path(ref_fasta_ann), path(ref_fasta_bwt), path(ref_fasta_pac), path(ref_fasta_sa)', cfsnv_stdprep_text)
        self.assertIn('path(ref_fasta), path(ref_fasta_fai), path(ref_fasta_dict), path(ref_fasta_amb), path(ref_fasta_ann), path(ref_fasta_bwt), path(ref_fasta_pac), path(ref_fasta_sa)', cfsnv_cfdnaprep_text)
    ...
    def test_reference_assets_are_staged_for_all_container_modules(self) -> None:
        ...
        self.assertIn('path(ref_fasta), path(ref_fasta_fai), path(ref_fasta_dict), path(ref_fasta_amb), path(ref_fasta_ann), path(ref_fasta_bwt), path(ref_fasta_pac), path(ref_fasta_sa), path(snp_database), path(snp_database_tbi)', cfsnv_stdprep_text)
        self.assertIn('path(ref_fasta), path(ref_fasta_fai), path(ref_fasta_dict), path(ref_fasta_amb), path(ref_fasta_ann), path(ref_fasta_bwt), path(ref_fasta_pac), path(ref_fasta_sa), path(snp_database), path(snp_database_tbi)', cfsnv_cfdnaprep_text)
