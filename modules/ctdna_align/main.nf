process UMI_ALIGN_BWA {
    label 'cpu_large'
    publishDir "${params.results_dir}/ctdna/alignment", mode: 'copy'
    ...
    ${params.bwa_binary} mem \
      ...
      ${r1} \
      ${r2} \
    | samtools sort -@ "\$SORT_THREADS" -o ${meta.sample_id}.umi.sorted.bam
    samtools index ${meta.sample_id}.umi.sorted.bam
    samtools quickcheck ${meta.sample_id}.umi.sorted.bam
    """

    stub:
    """
    touch ${meta.sample_id}.umi.sorted.bam ${meta.sample_id}.umi.sorted.bam.bai
    """
}
